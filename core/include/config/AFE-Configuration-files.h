...
#define AFE_CONFIG_FILE_BUFFER_CLED_EFFECT_BLINKING 332 // @TODO T7
#define AFE_CONFIG_FILE_BUFFER_CLED_EFFECT_WAVE 332 // @TODO T7
#define AFE_CONFIG_FILE_BUFFER_CLED_EFFECT_FADE_INOUT 332 // @TODO T7
