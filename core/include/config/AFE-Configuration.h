...
#define AFE_FIRMWARE_VERSION "2.4.0.B2"
...
/* Max number of hardware items per specyfic hardware device */
#define AFE_CONFIG_HARDWARE_NUMBER_OF_RELAYS 32
#define AFE_CONFIG_HARDWARE_NUMBER_OF_SWITCHES 32
#define AFE_CONFIG_HARDWARE_NUMBER_OF_LEDS 32
