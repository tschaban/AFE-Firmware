...
#define AFE_CONFIG_HARDWARE_CLED_GPIO 14
#define AFE_CONFIG_HARDWARE_CLED_CHIPSET WS2811
#define AFE_CONFIG_HARDWARE_CLED_COLOLRS_ORDER GRB
...
#define AFE_CONFIG_HARDWARE_EFFECT_WAVE 1
#define AFE_CONFIG_HARDWARE_EFFECT_FADE_IN_OUT 2
