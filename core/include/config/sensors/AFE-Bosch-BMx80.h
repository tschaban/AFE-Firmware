...
/**
 * @brief AFE_CONFIG_API_JSON_BMEX80_DATA_REAL_LENGTH
 * It's calculated real version of the JSON size + 10 buffer - work arround as AsynMQTTCrashes @TODO T6
 */
#define AFE_CONFIG_API_JSON_BMEX80_DATA_REAL_LENGTH strlen("{'temperature':{'value':999.9999,'unit':'C','correction':99.9999},'pressure':{'value':9999.9999,'unit':'hPa','correction':9999.9999},'relativePressure':{'value':9999.999,'unit':'hPa'},'dewPoint':{'value':999.999999,'unit':'C'},'humidity':{'value':999.99999,'unit':'%H','correction':999.99999,'rating':3},'absoluteHumidity':{'value':6.480335,'unit':'%H'},'heatIndex':{'value':999.99999,'unit':'C'},'perception':{'value':0,'description':'W porządku dla większości, ale wszyscy odczuwają wilgoć przy górnej krawędzi'},'comfort':{'value':4,'ratio':999.99999,'unit':'%','description':'Gorąco i wilgotno'},'iaq':{'value':9999,'rating':1,'accuracy':0},'staticIaq':{'value':9999,'rating':1,'accuracy':0},'co2Equivalent':{'value':99999,'unit':'ppm','rating':1,'accuracy':0},'breathVocEquivalent':{'value':99.999999,'unit':'?','accuracy':0},'gasResistance':{'value':99999.999,'unit':'kOm'}}")+200
