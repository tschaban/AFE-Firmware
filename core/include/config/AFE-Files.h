...
#define AFE_CONFIG_FILE_BUFFER_CLED 388 // AJ check
#define AFE_CONFIG_FILE_BUFFER_CLED_EFFECT_BLINKING 396 // AJ check
#define AFE_CONFIG_FILE_BUFFER_CLED_EFFECT_WAVE 334 //  AJ check
#define AFE_CONFIG_FILE_BUFFER_CLED_EFFECT_FADE_INOUT 283 
