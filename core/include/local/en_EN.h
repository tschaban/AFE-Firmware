...
#define L_NETWORK_CONNECT_TO "Connect now to your wireless network"
//#define L_NETWORK_CONNECT "Connect"
#define L_NETWORK_CONNECT_TO_PANEL "And open <a href=\"http://{{A}}.local\">Configuration Panel</a>"
#define L_NETWORK_SEARCH_FOR_IP_ADDRESS "If the link is not recognized in you LAN, look for an IP address of a device with MAC adress: {{M}} or hostname: AFE-Device"
