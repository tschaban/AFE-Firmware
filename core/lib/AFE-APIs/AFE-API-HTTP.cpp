...
/* Checking if Relay request */
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("Relay"), AFE_NONE, F("HTTP-API"));
#endif
...
/* Checking if Analog Input request */
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("ADC"), AFE_NONE, F("HTTP-API"));
#endif
...
/* Checking if Battery Meter request */
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("Batterymeter"), AFE_NONE, F("HTTP-API"));
#endif
...
/* Checking if BMx80 Input request */
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("Bosch BMx"), AFE_NONE, F("HTTP-API"));
#endif
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("BH1750"), AFE_NONE, F("HTTP-API"));
#endif
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("AS3935"), AFE_NONE, F("HTTP-API"));
#endif
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("HPMA115S0"), AFE_NONE, F("HTTP-API"));
#endif
...
/* Checking if Anemometer request */
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("Anemometer"), AFE_NONE, F("HTTP-API"));
#endif
...
/* Checking if Rain request */
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("Rainmeter"), AFE_NONE, F("HTTP-API"));
#endif
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("Gate"), AFE_NONE, F("HTTP-API"));
#endif
    processGate(request);
  }
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("Contactron"), AFE_NONE, F("HTTP-API"));
#endif
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("DS18B20"), AFE_NONE, F("HTTP-API"));
#endif
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("Regulator"), AFE_NONE, F("HTTP-API"));
#endif
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("Thermal Protector"), AFE_NONE, F("HTTP-API"));
#endif
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("DHTxx"), AFE_NONE, F("HTTP-API"));
#endif
    processDHT(request);
  }
#endif // AFE_CONFIG_HARDWARE_DS18B20
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("Binary sensor"), AFE_NONE, F("HTTP-API"));
#endif
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("TSL2561"), AFE_NONE, F("HTTP-API"));
#endif
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("RGB LED"), AFE_NONE, F("HTTP-API"));
#endif
    processCLED(request);
  }
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("RGB LED: Wave effect"), AFE_NONE, F("HTTP-API"));
#endif
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("RGB LED: FadeInOut effect"), AFE_NONE, F("HTTP-API"));
#endif
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("RGB LED: Blink effect"), AFE_NONE, F("HTTP-API"));
#endif
  ...
  {
#ifdef DEBUG
    _Firmware->Debugger->printProcessingRequest(F("FS3000"), AFE_NONE, F("HTTP-API"));
#endif
...
/* Command not implemented.Info */
    ...
    {
      _Firmware->Debugger->printInformation(F("Excluding relay: "), F("HTTP-API"));
      Serial << i
