...
const char HTTP_FIRMWARE_BANNER_IMAGE[] PROGMEM = "<img src=\"http://api.smartnydom.pl/logo/T{{f.t}}/{{f.v}}/{{f.n}}/{{f.h}}/{{f.l}}\" style=\"width: 100%;display: block\" alt=\"AFE Firmware\">"; 
const char HTTP_FIRMWARE_BANNER_TEXT[] PROGMEM = "<h3 class=\"la\">AFE Firmware T{{firmware.type}}v{{f.v}} {{f.d}}</h3>"; 


const char HTTP_FIRMWARE_INFO_ITEM[] PROGMEM = "<li style=\"text-decoration:none;padding-left:1.5em;color:#777;font-size:0.9em\">{{I}}</li>";
