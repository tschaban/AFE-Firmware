...
#define AFE_FIRMWARE_VERSION "2.1.0.RC1"
...
#define AFE_CONFIG_API_MQTT_TOPICS_CACHE_LENGTH AFE_CONFIG_HARDWARE_NUMBER_OF_RELAYS+AFE_CONFIG_HARDWARE_NUMBER_OF_SWITCHES+1
