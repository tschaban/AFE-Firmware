...
//  AFEEEPROM Eeprom;
  ...
  Serial << endl << "   - LAN by DHCP? : " << networkConfiguration.dhcp;
  ...
  Serial << endl << "   - Number of connection attempts : " << networkConfiguration.noConnectionAttempts;
  Serial << endl << "   - Duration between connecton attempts : " << networkConfiguration.waitTimeConnections;
  Serial << endl << "   - Duration between next connection attempts series : " << networkConfiguration.waitTimeSeries;
  ...
  Serial << endl << "    - State after power on : " << RelayConfiguration.statePowerOn;
  /* @TODO For MQTT only */
  Serial << endl << "    - Relay name : " << RelayConfiguration.name;
  Serial << endl << "    - Relay state after mqtt connected : " << RelayConfiguration.stateMQTTConnected;
  /* @TODO For Domoticz only */
  Serial << endl << "    - Domoticz IDX : " << RelayConfiguration.idx;
  Serial << endl << "    - Domoticz Publish state : " << RelayConfiguration.publishToDomoticz;
  ...
  Serial << endl << "    - Sensitiveness : " << SwitchConfiguration.sensitiveness;
  Serial << endl << "    - Functionality : " << SwitchConfiguration.functionality;
  ...
  Network.begin(networkConfiguration.ssid,networkConfiguration.password,networkConfiguration.host,WIFI_MODE_SERVER);
  Network.connect();
